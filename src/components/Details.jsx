                ...
                <Row className="r3">
                    <Col>
                        {this.state.addr && this.state.type === 'T' ? (
                            ...
                            <p>
                                This is a Z-address (shielded address) meaning your balance is hidden. To check your balance import your Spending Key into the <a href='https://github.com/HorizenOfficial/zencash-swing-wallet-ui/releases'>ZEN Swing Wallet</a>
                            </p>
                        ) : (
                            <p></p>
                        )}
